...
WEKO_ADMIN_MANAGEMENT_OPTIONS = {
    ...
    'dlt_index_sort_options':[
        ...
        {'id': 'itemType_asc', 'contents': 'ItemType(asc)', 'disableFlg':False},
        {'id': 'itemType_desc', 'contents': 'ItemType(desc)', 'disableFlg':False},
        ...
        {'id': 'pyear_asc', 'contents': 'Date_of_Issued(asc)', 'disableFlg':False},
        {'id': 'pyear_desc', 'contents': 'Date_of_Issued(desc)', 'disableFlg':False},
